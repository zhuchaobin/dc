...
public class OutStgTnumSubInVo {
	
	// 本次出库数量
	private float currOutstgTnum;
	public float getCurrOutstgTnum() {
		return currOutstgTnum;
	}
	public void setCurrOutstgTnum(float currOutstgTnum) {
		this.currOutstgTnum = currOutstgTnum;
	}
